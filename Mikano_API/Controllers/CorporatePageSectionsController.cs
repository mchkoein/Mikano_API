...
{
    [Authorize]
    [RoutePrefix("api/CorporatePageSections")]
    public class CorporatePageSectionsController : SharedController<SocketHub>
    {
        private CorporatePageSectionRepository rpstry = new CorporatePageSectionRepository();

        private string kSectionName = "corporatepagesections";
        ...
        public HttpResponseMessage GetAll([ModelBinder(typeof(WebApiDataSourceRequestModelBinder))]DataSourceRequest request, int parentId)
        {
            ...
            if (hasPermissions)
            {
                ...
                try
                {
                    ...
                    return Request.CreateResponse(HttpStatusCode.OK, rpstry.GetAll(parentId).Select(d => new
                    {
                        id = d.id,
