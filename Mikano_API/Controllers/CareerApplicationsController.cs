...
{
    [Authorize]
    [RoutePrefix("api/CareerApplications")]
    public class CareerApplicationsController : SharedController<SocketHub>
    {
        private CareerApplicationRepository rpstry = new CareerApplicationRepository();
        private string kSectionName = "careerapplications";
                    ...
                    else
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, new
                        {
                            model = new
                            {
                                ...
                                fileSrc = new UploadController().GetUploadedFiles(entry.fileSrc, null, careerApplicationsDirectory),
        ...
        [HttpPost, HttpPut]
        public HttpResponseMessage Details([ModelBinder(typeof(WebApiDataSourceRequestModelBinder))]DataSourceRequest request, CareerApplication entry, SubmissionOptions submissionType, bool inline = false)
        {
                ...
                if (ModelState.IsValid)
                {
                    try
                    {
                        ...
                        else if (hasPermissionsToUpdate)
                        {
                            ...
                            oldEntry.education = entry.education;
                            oldEntry.experience = entry.experience;
        ...
        //[HttpPost]
        //[AllowAnonymous]
        //public HttpResponseMessage SendRequest(CareerApplication entry)
        //{
        //	if (ModelState.IsValid)
        //	{
        //		try
