...
{
    [Authorize]
    [RoutePrefix("api/PartnerCategories")]
    public class PartnerCategoriesController : SharedController<SocketHub>
    {
        private PartnerCategoryRepository rpstry = new PartnerCategoryRepository();
        private string kSectionName = "PartnerCategories";
            ...
            if (hasPermissionsToCreate && id == -1 || hasPermissionsToUpdate && id != -1)
            {
                ...
                try
                {
                    ...
                    if (languageId.HasValue)
                    {
                        ...
                        entry = entry.PartnerCategories.FirstOrDefault(d => !d.isDeleted && d.languageId == languageId);
                    ...
                    else
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, new
                        {
                            ...
                            languages = languageRpstry.GetAllOptional().Select(e => new
                            {
                                ...
                                isFilled = entry.PartnerCategories.Any(d => !d.isDeleted && d.languageId == e.id)
                            }),
                            additionalData = new
                            {
                                publishOptions = publishOptions,
        ...
        [HttpPost, HttpPut]
        public HttpResponseMessage Details([ModelBinder(typeof(WebApiDataSourceRequestModelBinder))]DataSourceRequest request, PartnerCategory entry, SubmissionOptions submissionType, bool inline = false)
        {
                        ...
                        else
                        {
                            ...
                            return Request.CreateResponse(HttpStatusCode.OK, new
                            {
                                ...
                                languages = languageRpstry.GetAllOptional().Select(e => new
                                {
                                    ...
                                    title = e.title,
                                    isRightToLeft = e.isRightToLeft,
                                    isFilled = (entry.PartnerCategory1 ?? entry).PartnerCategories.Any(d => !d.isDeleted && d.languageId == e.id)
                                })
                            });
                        }
                    }
        ...
        public HttpResponseMessage Delete(string ids = "")
        {
            ...
            if (hasPermissions)
            {
                ...
                try
                {
                    PartnerCategory parentEntry = null;
                    ...
                    foreach (var parId in listOfIds)
                    {
                        ...
                        rpstry.Save();
                        parentEntry = entry.PartnerCategory1;
                    ...
                    return Request.CreateResponse(HttpStatusCode.OK, new
                    {
                        languages = parentEntry == null ? null : languageRpstry.GetAllOptional().Select(e => new
                        {
                            ...
                            title = e.title,
                            isRightToLeft = e.isRightToLeft,
                            isFilled = (parentEntry.PartnerCategory1 ?? parentEntry).PartnerCategories.Any(d => !d.isDeleted && d.languageId == e.id)
                        })
                    });
                }
                catch (Exception e)
        ...
        //{
        //    var PartnerCategories = rpstry.GetAllIsPublished().Select(d => new
        //    {
        //        id = d.id,
        //        title = d.title,
        //        icon = d.icon,
        //        link = d.link
        //    });
        //    return Request.CreateResponse(HttpStatusCode.OK, PartnerCategories);
        //}
        #endregion
    }
