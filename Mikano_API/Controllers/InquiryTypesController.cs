...
{
    [Authorize]
    [RoutePrefix("api/InquiryTypes")]
    public class InquiryTypesController : SharedController<SocketHub>
    {
        private InquiryTypeRepository rpstry = new InquiryTypeRepository();
        private string kSectionName = "inquirytypes";
        ...
        [HttpPost, HttpPut]
        public HttpResponseMessage Details([ModelBinder(typeof(WebApiDataSourceRequestModelBinder))]DataSourceRequest request, InquiryType entry, SubmissionOptions submissionType, bool inline = false)
        {
        ...
        public HttpResponseMessage GetData()
        {
            ...
            {
                var entryTranslatedItem = requestedLanguageId == -1 ? null : entryItem.InquiryTypes.FirstOrDefault(lang => lang.languageId == requestedLanguageId);
