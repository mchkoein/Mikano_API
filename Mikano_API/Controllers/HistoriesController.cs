...
namespace Mikano_API.Controllers
{
    ...
    public class HistoriesController : SharedController<SocketHub>
    {
        private HistoryRepository rpstry = new HistoryRepository();
        private string kSectionName = "Histories";
            ...
            if (hasPermissionsToCreate && id == -1 || hasPermissionsToUpdate && id != -1)
            {
                ...
                try
                {
                    ...
                    if (languageId.HasValue)
                    {
                        ...
                        entry = entry.Histories.FirstOrDefault(d => !d.isDeleted && d.languageId == languageId);
                    ...
                    else
                    {
                        return Request.CreateResponse(HttpStatusCode.OK, new
                        {
                            model = new
                            {
                                ...
                                imgSrc = new UploadController().GetUploadedFiles(entry.imgSrc,null, historyDirectory),
                            ...
                            languages = languageRpstry.GetAllOptional().Select(e => new
                            {
                                ...
                                isFilled = entry.Histories.Any(d => !d.isDeleted && d.languageId == e.id)
                            }),
                            additionalData = new
                            {
                                publishOptions = publishOptions,
        ...
        [HttpPost, HttpPut]
        public HttpResponseMessage Details([ModelBinder(typeof(WebApiDataSourceRequestModelBinder))]DataSourceRequest request, History entry, SubmissionOptions submissionType, bool inline = false)
        {
                        ...
                        else
                        {
                            ...
                            return Request.CreateResponse(HttpStatusCode.OK, new
                            {
                                ...
                                languages = languageRpstry.GetAllOptional().Select(e => new
                                {
                                    ...
                                    title = e.title,
                                    isRightToLeft = e.isRightToLeft,
                                    isFilled = (entry.History1 ?? entry).Histories.Any(d => !d.isDeleted && d.languageId == e.id)
                                })
                            });
                        }
                    }
                ...
                try
                {
                    ...
                    return Request.CreateResponse(HttpStatusCode.OK, new
                    {
                        languages = parentEntry == null ? null : languageRpstry.GetAllOptional().Select(e => new
                        {
                            ...
                            title = e.title,
                            isRightToLeft = e.isRightToLeft,
                            isFilled = (parentEntry.History1 ?? parentEntry).Histories.Any(d => !d.isDeleted && d.languageId == e.id)
                        })
                    });
                }
                catch (Exception e)
        ...
        //{
        //    var Histories = rpstry.GetAllIsPublished().Select(d => new
        //    {
        //        id = d.id,
        //        title = d.title,
        //        icon = d.icon,
